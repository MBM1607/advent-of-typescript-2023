...
import type { TicTacToe } from "./solution.js";
...
type test_invalid_actual = TicTacToe<
	{
		board: [["  ", "❌", "  "], ["  ", "  ", "  "], ["  ", "  ", "  "]];
		state: "⭕";
	},
...
type test_before_diagonal_win = {
	board: [["⭕", "❌", "❌"], ["⭕", "⭕", "❌"], ["❌", "  ", "  "]];
	state: "⭕";
};
type test_diagonal_win_actual = TicTacToe<test_before_diagonal_win, "bottom-right">;
type test_diagonal_win_expected = {
	board: [["⭕", "❌", "❌"], ["⭕", "⭕", "❌"], ["❌", "  ", "⭕"]];
	state: "⭕ Won";
};
type test_diagonal_win = Expect<Equal<test_diagonal_win_actual, test_diagonal_win_expected>>;
