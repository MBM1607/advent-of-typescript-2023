...
import type { Validate } from "./solution.js";
...
>;
type test_sudoku_7 = Expect<Equal<test_sudoku_5_actual, false>>;
...
>;
type test_sudoku_8 = Expect<Equal<test_sudoku_5_actual, false>>;
type test_sudoku_9_actual = Validate<
	[
		[["💃", "🦌", "💨"], ["❤️", "🌟", "☄️"], ["🌩️", "🔴", "⚡"]],
		[["💨", "💃", "🦌"], ["☄️", "❤️", "🌩️"], ["🌟", "⚡", "🔴"]],
		[["🌟", "⚡", "🔴"], ["💨", "💃", "🦌"], ["☄️", "❤️", "🌩️"]],
...
type test_sudoku_9 = Expect<Equal<test_sudoku_5_actual, false>>;
